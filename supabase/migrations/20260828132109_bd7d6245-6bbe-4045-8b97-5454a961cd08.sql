...
BEGIN
  ...
  CASE p_scope
    WHEN 'chat' THEN v_limit := 10; v_window_seconds := 600;
    WHEN 'market' THEN v_limit := 120; v_window_seconds := 60;
    WHEN 'calendar' THEN v_limit := 30; v_window_seconds := 600;
    WHEN 'news' THEN v_limit := 30; v_window_seconds := 600;
